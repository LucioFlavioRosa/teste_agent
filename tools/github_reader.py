...
def conection(repositorio: str) -> object:
    """
    Cria uma conexão autenticada com o repositório GitHub.
...
def _leitura_recursiva_com_debug(repo, extensoes, path="", arquivos_do_repo=None) -> dict:
    ...
    Args:
        repo: Objeto de repositório do PyGithub.
        extensoes: Lista de extensões alvo.
        path (str): Caminho inicial.
        arquivos_do_repo (dict): Dicionário acumulador.

    Returns:
        dict: Dicionário de arquivos e seus conteúdos.
    """
...
def main(repo: str, tipo_de_analise: str) -> dict:
    """
    Função principal para leitura de arquivos do repositório GitHub.
