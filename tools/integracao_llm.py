...
class LLMAnalyzer:
    """
    Abstrai integração com o LLM da OpenAI, facilitando mocks e testes.
    """
    def __init__(self):
    ...
    def carregar_prompt(self, tipo_analise: str) -> str:
        ...
        caminho_prompt = os.path.join(caminho_base, 'prompt', f'{tipo_analise}.md')
        try:
    ...
    def executar_analise_llm(self,
        ...
        """
        Executa a análise via LLM, utilizando o prompt adequado.
        """
