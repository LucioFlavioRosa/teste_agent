...
def executar_analise_llm(
    ...
    """
    Executa análise utilizando modelo LLM OpenAI com base no prompt e código fornecidos.

    Args:
        tipo_analise (str): Tipo de análise.
        codigo (str): Código-fonte ou dicionário de arquivos a ser analisado.
    ...
    Returns:
        str: Conteúdo da resposta do modelo LLM.

    Raises:
        RuntimeError: Em caso de falha na chamada à API OpenAI.
    """
