...
class AnaliseLLM:
    """
    Adaptador para execução de análise LLM (OpenAI), permitindo injeção de cliente externo.
    """
    def __init__(self, openai_client=None, openai_api_key=None):
    ...
    def executar(self, tipo_analise: str, codigo: str, analise_extra: str, model_name: str, max_token_out: int) -> str:
