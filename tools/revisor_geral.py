...
def executar_analise_llm(
    ...
    """
    Executa a análise usando um modelo LLM, preparando as mensagens e realizando a chamada.
    ...
    Returns:
        str: Resultado da análise retornado pelo LLM.

    Raises:
        RuntimeError: Se ocorrer erro na chamada à API da OpenAI.
    """
