...
def code_from_repo(repositorio: str, tipo_analise: str):
    """
    Lê o código de um repositório remoto para análise.
    ...
    Returns:
        dict: Dicionário com os arquivos e conteúdos do repositório.

    Raises:
        RuntimeError: Se ocorrer falha ao executar a análise.
    """
    try:
...
def validation(tipo_analise: str,
    ...
    Args:
        ...
        codigo (Optional[str]): Código-fonte a ser analisado.

    Returns:
        dict or str: Código para análise.
...
def main(tipo_analise: str,
    ...
    """
    Orquestra o processo de análise de código usando LLM.
    ...
    Args:
        ...
        max_token_out (int): Máximo de tokens na saída.
