...
from agents.agente_revisor import orquestrador_padrao

nome_do_repositorio = "LucioFlavioRosa/agent-vinna"

resposta_desing = orquestrador_padrao.executar_analise(tipo_analise='pentest', repositorio=nome_do_repositorio)
...
def rodar_analise():
    ...
    try:
        ...
        resultado = orquestrador_padrao.executar_analise(
