...
# Exemplo de chamada direta (comentada para evitar execução automática em contexto de produção)
...
def rodar_analise():
    """Endpoint para rodar análise do agente revisor."""
...
@app.route("/")
def index():
    """Endpoint raiz, exibe mensagem de status."""
