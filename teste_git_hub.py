...
def executar_analise():
    """
    Executa uma análise de pentest no repositório especificado.
...
def rodar_analise():
    """
    Endpoint para executar análise de código via API.
...
def index():
    """
    Endpoint raiz para verificação de disponibilidade do servidor.
