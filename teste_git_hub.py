...
# Exemplo de uso desacoplado (fora do contexto Flask)
def exemplo_analise():
...
if __name__ == '__main__':
    # Separação clara entre execução de exemplo e servidor
    # exemplo_analise()  # Descomente para rodar exemplo isolado
