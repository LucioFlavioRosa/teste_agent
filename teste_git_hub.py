...
def executar_analise(tipo_analise: str, repositorio: str = None, codigo: str = None, instrucoes_extras: str = ""):
    """
    Executa a análise utilizando o agente revisor, recebendo parâmetros necessários.

    Args:
        tipo_analise (str): Tipo de análise a ser realizada.
        repositorio (str): Nome do repositório GitHub.
        codigo (str): Código-fonte fornecido diretamente.
        instrucoes_extras (str): Instruções adicionais para a análise.

    Returns:
        dict: Resultado da análise.
    """
    return agente_revisor.main(
...
def rodar_analise():
    """
    Endpoint para executar análise via POST, recebendo JSON com parâmetros.

    Returns:
        Response: Resposta JSON com resultado ou erro.
    """
