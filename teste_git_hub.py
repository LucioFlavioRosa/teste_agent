# -*- coding: utf-8 -*-
"""
Script de teste e execução de API Flask para análise de repositórios GitHub.
Inclui exemplo de uso do agente revisor e definição dos endpoints web.
"""
...
def executar_teste_pentest():
    """
    Executa análise de pentest no repositório especificado e imprime o resultado.
    """
...
def rodar_analise():
    """
    Endpoint para executar análise a partir de requisição POST JSON.
    Espera parâmetros: tipo_analise, repositorio, codigo, instrucoes_extras.
    Retorna resultado da análise ou mensagem de erro.
    """
