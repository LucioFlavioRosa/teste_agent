...
def executar_exemplo_analise() -> None:
    """
    Executa um exemplo de análise de pentest e imprime o resultado.
    """
...
def rodar_analise():
    """
    Endpoint para executar análise via requisição POST.
    """
    ...
    try:
        ...
        # Em produção, evite expor stack trace ao usuário.
        # traceback.print_exc()
