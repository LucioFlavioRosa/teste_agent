# -*- coding: utf-8 -*-
"""
Exemplo de uso e inicialização do app Flask para análise de repositórios.
Este arquivo foi modularizado para separar lógica de aplicação e facilitar testes.
"""
