# -*- coding: utf-8 -*-
"""
Módulo de inicialização da aplicação Flask e exemplos de uso.
Separado da lógica de negócio para facilitar manutenção e testes.
"""
...
def rodar_analise():
    ...
    req_data, error_response, status_code = get_request_data()
    if error_response:
